...
######################################################################################
i18n=  {"nojob":"Start treatment","ocd":"Be depressed","Search":"Search","switchTheme":"switch theme","home":"home","comments":"comments","run":"run ","days":" days","Previous":"Previous","Next":"Next"}
i18nCN={"nojob":"全力治病","ocd":"和病魔抗争","Search":"搜索","switchTheme":"切换主题","home":"首页","comments":"评论","run":"网站运行","days":"天","Previous":"上一页","Next":"下一页"}
i18nRU={"nojob":"Start treatment","ocd":"Be depressed","Search":"Поиск","switchTheme": "Сменить тему","home":"Главная","comments":"Комментарии","run":"работает ","days":" дней","Previous":"Предыдущая","Next":"Следующая"}
IconBase={
...
if os.environ.get('GITHUB_EVENT_NAME')!='schedule':
    ...
    readme=readme+"### Powered by :heart: [Gmeek](https://github.com/xiaobinliu/Gmeek)\r\n"
